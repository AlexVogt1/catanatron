...
@register_player("PSP")
class PlayStylePlayer(Player):
	i = 0
	def __init__(self, color, is_bot=True, playstyle='Random'):
		self.init_model(playstyle=playstyle)
		super().__init__(color, is_bot)

	def init_model(self,playstyle= 'Random'):
